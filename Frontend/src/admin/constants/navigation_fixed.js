import {
    ...
    Plus, Trash2, FileOutput, Settings
} from 'lucide-react';
...
export const NAV = [
    // --- TỔNG QUAN ---
    { id: 'dashboard', type: 'navigation', label: 'Tổng quan', section: 'Điều hướng', icon: LayoutDashboard, to: '/admin', keywords: ['dashboard', 'home', 'trang chu', 'thong ke'] },
...
/**
 * Chuyển đổi từ danh sách phẳng sang cấu trúc NAV cũ cho Sidebar
 */
export const getSidebarNav = () => {
    ...
    NAV.forEach(cmd => {
        ...
        if (cmd.section && cmd.section !== currentSection) {
            sidebar.push({ section: cmd.section });
